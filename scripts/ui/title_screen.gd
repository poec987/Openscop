...
func check_files():
	if FileAccess.file_exists("user://savedata/saveslot0.save"):
		...
		$PSXLayer/NTSC/NTSC_viewport/Dither/dither_view/no_filter_view/no_filter_view/file_select/files/file0/Label.text = file_data["game"]["save_name"]
		...
		$PSXLayer/NTSC/NTSC_viewport/Dither/dither_view/no_filter_view/no_filter_view/file_select/files/file0/Label.text = "Empty Game"
	...
	if FileAccess.file_exists("user://savedata/saveslot1.save"):
		...
		$PSXLayer/NTSC/NTSC_viewport/Dither/dither_view/no_filter_view/no_filter_view/file_select/files/file1/Label.text = file_data["game"]["save_name"]
		...
		$PSXLayer/NTSC/NTSC_viewport/Dither/dither_view/no_filter_view/no_filter_view/file_select/files/file1/Label.text = "Empty Game"
	...
	if FileAccess.file_exists("user://savedata/saveslot2.save"):
		...
		$PSXLayer/NTSC/NTSC_viewport/Dither/dither_view/no_filter_view/no_filter_view/file_select/files/file2/Label.text = file_data["game"]["save_name"]
